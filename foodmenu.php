...
<body class="relative">
   ...
   <div class="relative">
      <div class="w-full h-60 bgfoodmenu mx-auto flex justify-center items-center">
        <div class="">
          <h1 class="headtxt font-black text-white text-5xl drop-shadow ">Browse our food menu</h1>
        </div>
   ...
   <div class="md:px-52 w-full pb-10 mx-auto flex justify-center items-center">
        <iframe src="https://drive.google.com/file/d/13nBQsL1oi1PGDDikZjt1GUsXFNzLNRPA/preview" frameborder="0" class="w-[1200px] h-[3000px] rounded bg-gray-100 " ></iframe>
    </div>
