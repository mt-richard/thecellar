          ...
          <div class="flex flex-wrap text-center py-5">
            <div class="py-3 px-5 md:w-1/4 sm:w-1/2 w-full">
              <div class="border border-gray-200 hover:bg-red-100  bg-gray-100 flex justify-center items-center py-5 gap-2 rounded-3xl px-3">
                ...
                <div>
                  <p class="font-semibold text-xl text-gray-500">Coffee & Tea</p>
                </div>
              </div>
            </div>
            ...
            <div class="py-3 px-5 md:w-1/4 sm:w-1/2 w-full">
              <div class="border border-gray-200 hover:bg-red-100  bg-gray-100 flex justify-center items-center py-5 gap-2 rounded-3xl px-3">
                ...
                <div>
                  <p class="font-semibold text-xl text-gray-500">Cookies & Muffins</p>
                </div>
              </div>
            </div>
            ...
            <div class="py-3 px-5 md:w-1/4 sm:w-1/2 w-full">
              <div class="border border-gray-200 hover:bg-red-100  bg-gray-100 flex justify-center items-center py-5 gap-2 rounded-3xl px-3">
                ...
                <div>
                  <p class="font-semibold text-xl text-gray-500">Salads & Wraps</p>
                </div>
              </div>
            </div>
            ...
            <div class="py-3 px-5 md:w-1/4 sm:w-1/2 w-full">
              <div class="border border-gray-200 hover:bg-red-100  bg-gray-100 flex justify-center items-center py-5 gap-2 rounded-3xl px-3">
                <div class="img">
                  <img src="./icons/icons8-blender-96.png" width="50" height="50" alt="">
                </div>
                <div>
                  <p class="font-semibold text-xl text-gray-500">Yogurts Oatmeals</p>
                </div>
              </div>
            </div>
            ...
            <div class="py-3 px-5 md:w-1/4 sm:w-1/2 w-full">
              <div class="border border-gray-200 hover:bg-red-100  bg-gray-100 flex justify-center items-center py-5 gap-2 rounded-3xl px-3">
                ...
                <div>
                  <p class="font-semibold text-xl text-gray-500">Cakes & Sandwitches</p>
                </div>
              </div>
            </div>
            ...
            <div class="py-3 px-5 md:w-1/4 sm:w-1/2 w-full">
              <div class="border border-gray-200 px-5 hover:bg-red-100  bg-gray-100 flex justify-center items-center py-5 gap-5 rounded-3xl">
                <div class="img">
                  <img src="./icons/icons8-wine-bar-96.png" width="50" height="50" alt="">
                </div>
                <div>
                  <p class="font-semibold text-xl text-gray-500">Fruits Juice & Smothies</p>
                </div>
              </div>
            </div>
