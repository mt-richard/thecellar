    ...
    <div id="myDiv" class="hslideshow-container w-full items-center text-center mx-auto  py-10">
        ...
        <div class=" w-full z-10 ">
            <div class=" text-center px-60">
                ...
                <button type="button" class="bg-main px-6 rounded-3xl py-3 uppercase font-semibold text-white border-none outline-none hover:bg-white hover:text-main hover:shadow">book a table</button>
            </div>
        </div>
            ...
            <div class="container px-10 py-10 bg-gray-200 mx-auto flex gap-4 sm:flex-nowrap flex-wrap">
                ...
                <div class="md:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    if(isset($_POST['book'])){
                        ...
                        $cat = new booking(null,$_POST['name'],$_POST['phone'],$_POST['email'],$_POST['checkin'],$_POST['time'],$_POST['guests'],$_POST['space']);
                        $result = $cat->save();
    ...
    <section class="text-gray body-font overflow-hidden py-10  md:px-56 z-1 mx-auto">
        <div class="container px-10 py-10 mx-auto flex gap-4 sm:flex-nowrap flex-wrap">
            ...
            <div class="md:w-2/5 bg-gray-200 md:ml-auto w-full md:py-5 mt-8 md:mt-0 p">
                    ...
                    <button class="text-white bg-main border-0 ml-3 py-3 px-3 rounded w-1/2 font-[400]">Send</button>
                    </div>
            </div>
        </div>
    </section>
